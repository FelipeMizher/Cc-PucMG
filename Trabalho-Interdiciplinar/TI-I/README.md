...
* Integrar conteúdos vistos em diferentes disciplinas do curso
* Desenvolver o trabalho em equipe
* Aplicar conceitos de computação na resolução de problemas reais
* Exercitar a organização, planejamento e execução de projetos
* Desenvolver habilidades de comunicação e documentação técnica
