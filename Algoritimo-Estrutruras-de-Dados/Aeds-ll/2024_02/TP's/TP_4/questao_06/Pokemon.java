...
class Hash{
    ...
    Hash(int tamTab, int tamReserva){
        this.tamTab = tamTab;
        this.hash = new Pokemon[tamTab];
        for(int i = 0; i < tamTab; i++){
            hash[i] = null;
        }
    }

    public int h(Pokemon elemento){
        int resp = 0;
        String name;
    ...
    public int rehash(Pokemon elemento){
        int resp = 0;
        String name;
    ...
    public int pesquisar(Pokemon elemento, Log log){
        int pos = h(elemento);
        int resp = -1;
...
class Pokemon{
    ...
    public static Pokemon procuraNome(Pokemon p[], String nome){
        Pokemon x = new Pokemon();
    ...
    public static void inserirHash(Hash hash, Pokemon p[], Scanner sc) throws Exception{
    ...
    public static void procuraNaHash(Hash hash, Pokemon p[], Log log,Scanner sc){
        String nome = sc.nextLine();

        while(!nome.equals("FIM")){ 
            Pokemon x = procuraNome(p, nome);
    ...
    public static void main(String[] args) throws Exception{
        ...
        Hash hash = new Hash();
        Log log = new Log("/tmp/821811_hashReHash.txt");
